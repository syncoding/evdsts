...
# * Define URLs.
URL_MAIN_CATEGORIES: str = "https://evds3.tcmb.gov.tr/igmevdsms-dis/categories/"
URL_SUB_CATEGORIES: str = "https://evds3.tcmb.gov.tr/igmevdsms-dis/datagroups/"
URL_GROUPS: str = "https://evds3.tcmb.gov.tr/igmevdsms-dis/serieList/"
URL_SERIES: str = "https://evds3.tcmb.gov.tr/igmevdsms-dis/"
...
NOT_AVAILABLE_CATEGORIES: list[int] = []
...
FREQUENCY_REGEXES: dict[str, list[str]] = {
    "daily": [
        r"\b(?:[0]*[1-9]|[1-2][0-9]|[3][0-1])(?:-|\.|/|\\)(?:[0]*[1-9]|[1][0-2])(?:-|\.|/|\\)\d{4}\b"
    ],
    "bdaily": [
        r"\b(?:[0]*[1-9]|[1-2][0-9]|[3][0-1])(?:-|\.|/|\\)(?:[0]*[1-9]|[1][0-2])(?:-|\.|/|\\)\d{4}\b"
    ],
